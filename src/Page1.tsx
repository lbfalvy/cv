...
export const Page1 = () => <main className='Page1'>
  ...
  <Section title="Experience">
    <Timeline>
      <Experience from="2022-12" to="2023-02" role="Full-stack React Developer" employer="Ruuby LTD." website="ruuby.com">
        ...
        <Taglist tags="Docker, Rush.js, AWS, Node.js, Typescript, React.js, React-native, Express.js" />
      </Experience>
      ...
      <Experience from='2018-10' to='2019-03' role='.NET developer' employer='Remiz LTD'>
        ...
        <Taglist tags='C#, ASP.NET Core MVC, Entity Framework, Linq, Layered architecture' />
      </Experience>
  ...
  <Section title='Skills' meta={<>
    <Taglist tags='SQL, OOP, FP, Python, Ruby, Rust, Rush.js, AWS, React Native, Express, PHP, WordPress, MODX, C#, ASP.NET Core MVC, Entity Framework, Linq, Layered architecture' />
  </>}>
      <Dictionary>{[
        [
